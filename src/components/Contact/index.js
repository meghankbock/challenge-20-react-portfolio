        ...
        <section className="contact-container">
            <form className="contact-form" onSubmit={handleFormSubmit}>
                <div>
                    ...
                    <input className="form-input" type="text" id="firstName" name="first name" onBlur={handleChange}></input>
                </div>
                <div>
                    <label className="form-label" for="last name">Last Name:</label>
                    <input className="form-input" type="text" id="lastName" name="last name" onBlur={handleChange}></input>
                </div>
                <div>
                    <label className="form-label" for="email">Email:</label>
                    <input className="form-input" type="text" id="email" name="email" onBlur={handleChange}></input>
                </div>
                <div>
                    <label className="form-label" for="message">Message:</label>
                    <input className="form-input" type="text" id="message" name="message" onBlur={handleChange}></input>
                </div>
