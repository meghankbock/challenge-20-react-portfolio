const Resume = () => {
  ...
  return (
    ...
    <section id="resume-container" className="resume-container">
      ...
      <iframe id="iframeId" frameborder='0' src="https://docs.google.com/document/d/e/2PACX-1vRxeuHmtsMl9ZqCxP35NUpdfO8Qbx8nBI8PinB3PHXmdhPyV7xPrtESOtM579kpD4wsz_2naBxm_OeH/pub?embedded=true"></iframe>
      </div>
    </section>
  );
};
